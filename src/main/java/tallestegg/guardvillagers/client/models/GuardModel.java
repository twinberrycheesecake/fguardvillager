...
public class GuardModel extends HumanoidModel<Guard> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition torso = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(40, 78).addBox(-5.5F, -3.0F, -3.0F, 11.0F, 7.0F, 9.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(18, 98).addBox(-1.0F, 11.0F, 6.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition rightArm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(50, 94).addBox(-3.0F, -2.5F, 0.0F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        PartDefinition leftArm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(50, 94).mirror().addBox(0.0F, -2.5F, 0.0F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
