...
public class GuardModel extends HumanoidModel<Guard> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition torso = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(40, 78).addBox(-5.5F, -26.0F, -3.0F, 11.0F, 7.0F, 9.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(26, 4).addBox(-1.0F, -12.0F, 6.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 72).addBox(-2.5F, -33.0F, -3.0F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(26, 72).addBox(-3.5F, -34.0F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 0.0F, 0.0F));
        PartDefinition rightArm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(50, 94).addBox(-13.0F, -22.5F, -2.0F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 0.0F, 0.0F));
        PartDefinition leftArm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(50, 94).mirror().addBox(10.0F, -22.5F, -2.0F, 3.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-5.0F, 0.0F, 0.0F));
