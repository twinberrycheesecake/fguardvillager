...
public class GuardArmorModel extends HumanoidModel<Guard> {
    ...
    public static LayerDefinition createOuterArmorLayer() {
        ...
        partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, -0.5F, -1.5F, 8.0F, 10.0F, 4.0F, new CubeDeformation(2F))
                .texOffs(16, 16).addBox(-4.0F, 0.5F, 0.5F, 8.0F, 8.0F, 4.0F, new CubeDeformation(1.75F))
                .texOffs(16, 16).addBox(-4.0F, 4.8F, -3.0F, 8.0F, 7.0F, 4.0F, new CubeDeformation(2.2F))
                .texOffs(16, 16).addBox(-4.0F, 4.8F, -0.05F, 8.0F, 6.0F, 4.0F, new CubeDeformation(2.1F)), PartPose.offset(0.0F, 0.0F, 0.0F));
